...
<div style=" border: 2px solid black; margin: auto; width: 750px; margin-top: 79px;">
  <div class="d-flex flex-row">
   <div class="p-3"><img src="images/a.png" alt="Mi titulo de la imagen" style="width: 180px; margin:10px auto;
    ...
    <p style="text-align: center; font-weight: bold;">RECEPCIONAR REQUISICIÓN</p></div>
</div>
...
<div class="form-inline">
     ...
     <div class="form-group " style="width: 200px; margin-top: 15px; font-weight: bold;" >  
        ...
        <button type="submit" name="R_Recepcionado" id="R_Recepcionado" class="btn btn-success" style=" width:150px; margin-top:6px; ">Recepcionar Requisición</button>
        </div>
    </div>
</form>
</div>
