...
<div style=" 
  ...
  <div class="p-3"> <p style="text-align: center; padding-top: 20px; font-weight: bold;">UYEDA INDUSTRIAL DE MÉXICO SA DE CV.</p>
    <p style="text-align: center; font-weight: bold;">REQUISICIÓN DE AUTORIZACIÓN DIRECTOR</p></div>
...
$query = "SELECT RD.Id_Requisicion,RE.Requisicion,RD.Status,RD.Descripciond,RD.Cantidad,RD.Precio,RD.Cantidad * RD.Precio AS Importe, RD.Unidad,RE.Moneda FROM rq_requisiciond RD INNER JOIN rq_requisicione RE ON RE.Id_Requisicion = RD.Id_Requisicion WHERE RE.Id_Requisicion=$Id_Requisicion AND(RE.Status='Autorizada A2' and RE.Importe>30000 OR RE.Moneda = 'Pesos' AND RE.Importe>1500 OR RE.Moneda = 'Dolares')";
...
<div class="form-group" style="   justify-content: center;">
      ...
      <p  class="mx-2" style="text-align: center; font-weight: bold;">FIRMA DEL DIRECTOR</p>
