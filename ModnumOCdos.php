...
<div style=" border: 2px solid black; margin: auto; width: 750px; margin-top: 79px;">
    ...
    <p style="text-align: center; font-weight: bold;">MODIFICAR ORDEN DE COMPRA POR PRODUCTO</p></div>
...
<div class="form-inline">
     ...
     <div class="form-group " style="width: 200px; margin-top: 15px; font-weight: bold;" >
       ...
       <input type="number" name="NumeroOC" id="NumeroOC" class="form-control" placeholder="Ingresé un Número"> 
         ...
         <div class="form-group"  style="width: 100px; margin-top: 15px;" >
             <button type="submit" name="Cambiard" id="Cambiard"  class="btn btn-success" style=" width:200px; margin-top:6px; " onclick="return modificar_R();">Modificar Orden de Compra</button>
        </div>
    </div>
</form>
</div>
